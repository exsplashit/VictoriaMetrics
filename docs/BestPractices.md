...
It is recommended running the latest available release of VictoriaMetrics from [this page](https://github.com/exsplashit/VictoriaMetrics/releases), since it contains all the bugfixes and enhancements.
...
* [GitHub issues](https://github.com/exsplashit/VictoriaMetrics/issues)

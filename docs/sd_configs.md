...
Please file feature requests to [our issue tracker](https://github.com/exsplashit/VictoriaMetrics/issues) if you need other service discovery mechanisms to be supported by VictoriaMetrics and `vmagent`.

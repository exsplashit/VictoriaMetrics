...
********************************************************************************
  ...
  # See Release notes https://github.com/exsplashit/VictoriaMetrics/releases/tag/vVM_VERSION

  # Welcome to VictoriaMetrics droplet!

  # Website:       https://victoriametrics.com
  # Documentation: https://docs.victoriametrics.com
  # VictoriaMetrics Github : https://github.com/exsplashit/VictoriaMetrics

...
var (
	...
	queryTimeAlignment = flag.Bool("datasource.queryTimeAlignment", true, `Whether to align "time" parameter with evaluation interval.`+
		"Alignment supposed to produce deterministic results despite number of vmalert replicas or time they were started. See more details here https://github.com/exsplashit/VictoriaMetrics/pull/1257")
